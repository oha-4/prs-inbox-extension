...
function kindOf(pr: PullRequest): Kind {
...
export function StateIcon({ pr }: { pr: PullRequest }): React.JSX.Element {
  const kind = kindOf(pr);
  return (
    <svg className={`state-icon state-${kind}`} viewBox="0 0 16 16" width="16" height="16" aria-label={kind}>
